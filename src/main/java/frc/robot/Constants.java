...
*/
  ...
  public static final class TargetClassConstants{
    ...
    public static final float xValueA1XX = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC1XX + Math.PI) + AlgaeOffset * (float)Math.sin(zValueC1XX + Math.PI);
    public static final float yValueA1XX = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC1XX + Math.PI) + AlgaeOffset * (float)Math.cos(zValueC1XX + Math.PI);
    ...
    public static final float xValueA2XX = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC2XX + Math.PI) + AlgaeOffset * (float)Math.sin(zValueC2XX + Math.PI);
    public static final float yValueA2XX = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC2XX + Math.PI) + AlgaeOffset * (float)Math.cos(zValueC2XX + Math.PI);
    ...
    public static final float xValueA3XX = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC3XX + Math.PI) + AlgaeOffset * (float)Math.sin(zValueC3XX + Math.PI);
    public static final float yValueA3XX = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC3XX + Math.PI) + AlgaeOffset * (float)Math.cos(zValueC3XX + Math.PI);
    ...
    public static final float xValueA4XX = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC4XX + Math.PI) + AlgaeOffset * (float)Math.sin(zValueC4XX + Math.PI);
    public static final float yValueA4XX = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC4XX + Math.PI) + AlgaeOffset * (float)Math.cos(zValueC4XX + Math.PI);
    ...
    public static final float xValueA5XX = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC5XX + Math.PI) + AlgaeOffset * (float)Math.sin(zValueC5XX + Math.PI);
    public static final float yValueA5XX = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC5XX + Math.PI) + AlgaeOffset * (float)Math.cos(zValueC5XX + Math.PI);
    ...
    public static final float xValueA6XX = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC6XX + Math.PI) + AlgaeOffset * (float)Math.sin(zValueC6XX + Math.PI);
    public static final float yValueA6XX = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC6XX + Math.PI) + AlgaeOffset * (float)Math.cos(zValueC6XX + Math.PI);
