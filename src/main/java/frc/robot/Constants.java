...
*/
  ...
  public static final class TargetClassConstants{
    ...
    // Offset constants
    public static final float CoralLeftOffset = (float)Units.inchesToMeters(7.5);
    public static final float CoralRightOffset = (float)Units.inchesToMeters(5.75);
    public static final float BackOffset = (float)Units.inchesToMeters(-5.0);
    public static final float AlgaeRightOffset = (float)Units.inchesToMeters(9.0);
    public static final float AlgaeLeftOffset = (float)Units.inchesToMeters(9.0);
    ...
    public static final float xValueC1X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC1XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC1XX + Math.PI);
    public static final float yValueC1X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC1XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC1XX + Math.PI);

    public static final float xValueC1X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC1XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC1XX + Math.PI);
    public static final float yValueC1X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC1XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC1XX + Math.PI);
    
    public static final float xValueC130 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC1XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC1XX + Math.PI);
    public static final float yValueC130 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC1XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC1XX + Math.PI);

    public static final float xValueC131 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC1XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC1XX + Math.PI);
    public static final float yValueC131 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC1XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC1XX + Math.PI);

    public static final float xValueA1X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC1XX + Math.PI) + AlgaeLeftOffset * (float)Math.sin(zValueC1XX + Math.PI);
    public static final float yValueA1X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC1XX + Math.PI) - AlgaeLeftOffset * (float)Math.cos(zValueC1XX + Math.PI);
    public static final float xValueA1X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC1XX + Math.PI) - AlgaeRightOffset * (float)Math.sin(zValueC1XX + Math.PI);
    public static final float yValueA1X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC1XX + Math.PI) + AlgaeRightOffset * (float)Math.cos(zValueC1XX + Math.PI);
    ...
    public static final float xValueC2X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC2XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC2XX + Math.PI);
    public static final float yValueC2X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC2XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC2XX + Math.PI);

    public static final float xValueC2X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC2XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC2XX + Math.PI);
    public static final float yValueC2X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC2XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC2XX + Math.PI);
    
    public static final float xValueC230 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC2XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC2XX + Math.PI);
    public static final float yValueC230 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC2XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC2XX + Math.PI);

    public static final float xValueC231 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC2XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC2XX + Math.PI);
    public static final float yValueC231 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC2XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC2XX + Math.PI);

    public static final float xValueA2X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC2XX + Math.PI) + AlgaeLeftOffset * (float)Math.sin(zValueC2XX + Math.PI);
    public static final float yValueA2X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC2XX + Math.PI) - AlgaeLeftOffset * (float)Math.cos(zValueC2XX + Math.PI);
    public static final float xValueA2X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC2XX + Math.PI) - AlgaeRightOffset * (float)Math.sin(zValueC2XX + Math.PI);
    public static final float yValueA2X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC2XX + Math.PI) + AlgaeRightOffset * (float)Math.cos(zValueC2XX + Math.PI);
    ...
    public static final float xValueC3X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC3XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC3XX + Math.PI);
    public static final float yValueC3X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC3XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC3XX + Math.PI);

    public static final float xValueC3X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC3XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC3XX + Math.PI);
    public static final float yValueC3X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC3XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC3XX + Math.PI);
    
    public static final float xValueC330 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC3XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC3XX + Math.PI);
    public static final float yValueC330 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC3XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC3XX + Math.PI);

    public static final float xValueC331 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC3XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC3XX + Math.PI);
    public static final float yValueC331 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC3XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC3XX + Math.PI);

    public static final float xValueA3X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC3XX + Math.PI) + AlgaeLeftOffset * (float)Math.sin(zValueC3XX + Math.PI);
    public static final float yValueA3X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC3XX + Math.PI) - AlgaeLeftOffset * (float)Math.cos(zValueC3XX + Math.PI);
    public static final float xValueA3X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC3XX + Math.PI) - AlgaeRightOffset * (float)Math.sin(zValueC3XX + Math.PI);
    public static final float yValueA3X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC3XX + Math.PI) + AlgaeRightOffset * (float)Math.cos(zValueC3XX + Math.PI);
    ...
    public static final float xValueC4X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC4XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC4XX + Math.PI);
    public static final float yValueC4X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC4XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC4XX + Math.PI);

    public static final float xValueC4X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC4XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC4XX + Math.PI);
    public static final float yValueC4X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC4XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC4XX + Math.PI);
    
    public static final float xValueC430 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC4XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC4XX + Math.PI);
    public static final float yValueC430 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC4XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC4XX + Math.PI);

    public static final float xValueC431 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC4XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC4XX + Math.PI);
    public static final float yValueC431 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC4XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC4XX + Math.PI);

    public static final float xValueA4X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC4XX + Math.PI) + AlgaeLeftOffset * (float)Math.sin(zValueC4XX + Math.PI);
    public static final float yValueA4X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC4XX + Math.PI) - AlgaeLeftOffset * (float)Math.cos(zValueC4XX + Math.PI);
    public static final float xValueA4X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC4XX + Math.PI) - AlgaeRightOffset * (float)Math.sin(zValueC4XX + Math.PI);
    public static final float yValueA4X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC4XX + Math.PI) + AlgaeRightOffset * (float)Math.cos(zValueC4XX + Math.PI);
    ...
    public static final float xValueC5X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC5XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC5XX + Math.PI);
    public static final float yValueC5X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC5XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC5XX + Math.PI);

    public static final float xValueC5X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC5XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC5XX + Math.PI);
    public static final float yValueC5X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC5XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC5XX + Math.PI);
    
    public static final float xValueC530 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC5XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC5XX + Math.PI);
    public static final float yValueC530 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC5XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC5XX + Math.PI);

    public static final float xValueC531 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC5XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC5XX + Math.PI);
    public static final float yValueC531 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC5XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC5XX + Math.PI);

    public static final float xValueA5X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC5XX + Math.PI) + AlgaeLeftOffset * (float)Math.sin(zValueC5XX + Math.PI);
    public static final float yValueA5X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC5XX + Math.PI) - AlgaeLeftOffset * (float)Math.cos(zValueC5XX + Math.PI);
    public static final float xValueA5X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC5XX + Math.PI) - AlgaeRightOffset * (float)Math.sin(zValueC5XX + Math.PI);
    public static final float yValueA5X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC5XX + Math.PI) + AlgaeRightOffset * (float)Math.cos(zValueC5XX + Math.PI);
    ...
    public static final float xValueC6X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC6XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC6XX + Math.PI);
    public static final float yValueC6X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC6XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC6XX + Math.PI);

    public static final float xValueC6X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC6XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC6XX + Math.PI);
    public static final float yValueC6X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC6XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC6XX + Math.PI);
    
    public static final float xValueC630 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC6XX + Math.PI) + CoralLeftOffset * (float)Math.sin(zValueC6XX + Math.PI);
    public static final float yValueC630 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC6XX + Math.PI) - CoralLeftOffset * (float)Math.cos(zValueC6XX + Math.PI);
    
    public static final float xValueC631 = hexagonCenterX + (hexagonRadius - BackOffset) * (float)Math.cos(zValueC6XX + Math.PI) - CoralRightOffset * (float)Math.sin(zValueC6XX + Math.PI);
    public static final float yValueC631 = hexagonCenterY + (hexagonRadius - BackOffset) * (float)Math.sin(zValueC6XX + Math.PI) + CoralRightOffset * (float)Math.cos(zValueC6XX + Math.PI);

    public static final float xValueA6X0 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC1XX + Math.PI) + AlgaeLeftOffset * (float)Math.sin(zValueC6XX + Math.PI);
    public static final float yValueA6X0 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC1XX + Math.PI) - AlgaeLeftOffset * (float)Math.cos(zValueC6XX + Math.PI);
    public static final float xValueA6X1 = hexagonCenterX + hexagonRadius * (float)Math.cos(zValueC1XX + Math.PI) - AlgaeRightOffset * (float)Math.sin(zValueC6XX + Math.PI);
    public static final float yValueA6X1 = hexagonCenterY + hexagonRadius * (float)Math.sin(zValueC1XX + Math.PI) + AlgaeRightOffset * (float)Math.cos(zValueC6XX + Math.PI);
