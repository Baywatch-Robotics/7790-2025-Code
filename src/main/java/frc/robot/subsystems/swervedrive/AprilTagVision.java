        ...
        public static PhotonPoseEstimator rightPoseEstimator;
            ...
            private static PhotonPoseEstimator limelightPoseEstimator;
                ...
                public AprilTagVision() {
                    // THESE ARE BUGGED MOST LIKELY FIXED IN NEXT RELEASE
                    /*rightPoseEstimator = new PhotonPoseEstimator(fieldLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, , rightCam, rightCamToRobot);
                    leftPoseEstimator = new PhotonPoseEstimator(fieldLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, leftCam, leftCamToRobot);
                    limelightPoseEstimator = new PhotonPoseEstimator(fieldLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, limelight, limelightToRobot);*/
