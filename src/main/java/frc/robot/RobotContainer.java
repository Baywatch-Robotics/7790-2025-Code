...
public class RobotContainer
{
  ...
  // private static final double LINED_UP_ANGLE_THRESHOLD = Math.toRadians(5.0); // radians
...
*/
  ...
  /**
   * Update proximity status triggers based on current robot position and target pose
   */
  public void updateProximityStatus() {
    ...
    if (currentTarget != null) {
      ...
      // Update trigger states based on distance - now using constants from Constants class
